            ...
            for (int i = 0; i < legald.getChapters().get(w).getArticles().size(); i++) {
                ...
                for (int j = 0; j < legald.getChapters().get(w).getArticles().get(i).getParagraphs().size(); j++) {
                    ...
                    for (int k = 0; k < legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(
                        ...
                        String a = legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(
                                j).getPassages().get(k).getText();
                        a = trimDoubleQuotes(a);
                        paragraph3.add(a);
                        
                        //If passage has modifications
                        if (legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getPassages().get(
                            ...
                            if (legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(
                                ...
                                com.di.nomothesia.model.Article moda =
                                        (com.di.nomothesia.model.Article) legald.getChapters().get(w).getArticles().get(
                                ...
                                for (int z = 0; z < moda.getParagraphs().size(); z++) {
                                    ...
                                    for (int n = 0; n < moda.getParagraphs().get(z).getCaseList().size(); n++) {
                                        ...
                                        for (int l = 0; l < moda.getParagraphs().get(z).getCaseList().get(
                                            ...
                                            paragraph3.add(
                                                    moda.getParagraphs().get(z).getCaseList().get(n).getPassages().get(
                                                            l).getText());
                                        }
                                ...
                                com.di.nomothesia.model.Paragraph p =
                                        (com.di.nomothesia.model.Paragraph) legald.getChapters().get(
                                ...
                                Passage p =
                                        (Passage) legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(
                            ...
                            //If Modification type = Case
                                ...
                                //get Fragment
                                Case c = (Case) legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(
                                        j).getPassages().get(k).getModification().getFragment();
                    ...
                    for (int k = 0; k < legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(
                        ...
                        //get Case Passage
                        for (int l = 0; l < legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(
                                j).getCaseList().get(k).getPassages().size(); l++) {
                            
                            String b = legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(
                        ...
                        //Case in case
                        if (legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(j).getCaseList().get(
                                k).getCaseList() != null) {
                            
                            for (int p = 0; p < legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(
                                ...
                                for (int l = 0; l <
                                    ...
                                    String c = legald.getChapters().get(w).getArticles().get(i).getParagraphs().get(
                                            j).getCaseList().get(k).getCaseList().get(p).getPassages().get(l).getText();
