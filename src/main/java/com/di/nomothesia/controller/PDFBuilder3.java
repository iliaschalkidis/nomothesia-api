...
public class PDFBuilder3 extends AbstractITextPdfView {
    ...
    protected void buildPdfDocument(Map<String, Object> model, Document doc, PdfWriter writer,
        ...
        //Fonts
        BaseFont bf =
                BaseFont.createFont(getServletContext().getRealPath("/resources/fonts/arial.ttf"), BaseFont.IDENTITY_H,
                                    BaseFont.EMBEDDED);
        bf.setSubset(true);
        ...
        if (!legald.getCitations().isEmpty()) {
            ...
            for (int i = 0; i < legald.getCitations().size(); i++) {
                citation2 +=
                        legald.getCitations().get(i).getId() + ". " + legald.getCitations().get(i).getDescription() +
                                "\n\n";
            }
            ...
            if (!legald.getParts().get(t).getChapters().isEmpty()) {
                ...
                for (int w = 0; w < legald.getParts().get(t).getChapters().size(); w++) {
                    ...
                    for (int i = 0; i < legald.getParts().get(t).getChapters().get(w).getArticles().size(); i++) {
                        ...
                        //ID
                        par2 = article_header + " " +
                                legald.getParts().get(t).getChapters().get(w).getArticles().get(i).getId() + "\n";
                        article = new Paragraph(par2, fontArticle);
                        article.setAlignment(Element.ALIGN_CENTER);
                        doc.add(article);
                        ...
                        if (legald.getParts().get(t).getChapters().get(w).getArticles().get(i).getTitle() != null) {
                            String par3 =
                                    legald.getParts().get(t).getChapters().get(w).getArticles().get(i).getTitle() +
                                            "\n";
                            Paragraph articlet = new Paragraph(par3, fontArticle);
                            articlet.setAlignment(Element.ALIGN_CENTER);
                            doc.add(articlet);
                        ...
                        //For all Paragraphs
                        for (int j = 0; j < legald.getParts().get(t).getChapters().get(w).getArticles().get(
                                i).getParagraphs().size(); j++) {
                            
                            //get Paragraph id
                            paragraph3.add("" + legald.getParts().get(t).getChapters().get(w).getArticles().get(
                                    i).getParagraphs().get(j).getId() + ". ");
                            
                            //get Passages
                            for (int k = 0; k < legald.getParts().get(t).getChapters().get(w).getArticles().get(
                                    i).getParagraphs().get(j).getPassages().size(); k++) {
                                
                                String a = legald.getParts().get(t).getChapters().get(w).getArticles().get(
                                        i).getParagraphs().get(j).getPassages().get(k).getText();
                                a = trimDoubleQuotes(a);
                                paragraph3.add(a);
                                
                                //If passage has modifications
                                if (legald.getParts().get(t).getChapters().get(w).getArticles().get(
                                        i).getParagraphs().get(j).getPassages().get(k).getModification() != null) {
                                    ...
                                    if (legald.getParts().get(t).getChapters().get(w).getArticles().get(
                                        ...
                                        com.di.nomothesia.model.Article moda =
                                                (com.di.nomothesia.model.Article) legald.getParts().get(
                                                        t).getChapters().get(w).getArticles().get(
                                                        i).getParagraphs().get(j).getPassages().get(
                                        ...
                                        for (int z = 0; z < moda.getParagraphs().size(); z++) {
                                            ...
                                            for (int n = 0; n < moda.getParagraphs().get(z).getPassages().size(); n++) {
                                                paragraph3.add(
                                                        moda.getParagraphs().get(z).getPassages().get(n).getText());
                                            }
                                            ...
                                            for (int n = 0; n < moda.getParagraphs().get(z).getCaseList().size(); n++) {
                                                ...
                                                paragraph3.add(
                                                        moda.getParagraphs().get(z).getCaseList().get(n).getId() + "");
                                                
                                                //get MOdification Case Passage text
                                                for (int l = 0; l < moda.getParagraphs().get(z).getCaseList().get(
                                                        n).getPassages().size(); l++) {
                                                    paragraph3.add(moda.getParagraphs().get(z).getCaseList().get(
                                                            n).getPassages().get(l).getText());
                                                }
                                    ...
                                    } else if (legald.getParts().get(t).getChapters().get(w).getArticles().get(
                                            i).getParagraphs().get(j).getPassages().get(
                                            k).getModification().getType().equals("Paragraph")) {
                                        
                                        com.di.nomothesia.model.Paragraph p =
                                                (com.di.nomothesia.model.Paragraph) legald.getParts().get(
                                                        t).getChapters().get(w).getArticles().get(
                                                        i).getParagraphs().get(j).getPassages().get(
                                                        k).getModification().getFragment();
                                        ...
                                        paragraph3.add("\n");
                                            ...
                                            i).getParagraphs().get(j).getPassages().get(
                                            k).getModification().getType().equals("Passage")) {
                                        
                                        Passage p = (Passage) legald.getParts().get(t).getChapters().get(
                                    ...
                                    //If Modification type = Case
                                            ...
                                            i).getParagraphs().get(j).getPassages().get(
                                            k).getModification().getType().equals("Case")) {
                                        
                                        //get Fragment
                                        Case c = (Case) legald.getParts().get(t).getChapters().get(w).getArticles().get(
                                                i).getParagraphs().get(j).getPassages().get(
                                                k).getModification().getFragment();
                            ...
                            for (int k = 0; k < legald.getParts().get(t).getChapters().get(w).getArticles().get(
                                ...
                                //get Case Passage
                                for (int l = 0; l < legald.getParts().get(t).getChapters().get(w).getArticles().get(
                                        i).getParagraphs().get(j).getCaseList().get(k).getPassages().size(); l++) {
                                    
                                    String b = legald.getParts().get(t).getChapters().get(w).getArticles().get(
                                            i).getParagraphs().get(j).getCaseList().get(k).getPassages().get(
                                            l).getText();
                                ...
                                //Case in case
                                if (legald.getParts().get(t).getChapters().get(w).getArticles().get(
                                        i).getParagraphs().get(j).getCaseList().get(k).getCaseList() != null) {
                                    
                                    for (int p = 0; p < legald.getParts().get(t).getChapters().get(w).getArticles().get(
                                            i).getParagraphs().get(j).getCaseList().get(k).getCaseList().size(); p++) {
                                        ...
                                        //get Case Passage
                                        for (int l = 0; l <
                                                legald.getParts().get(t).getChapters().get(w).getArticles().get(
                                                        i).getParagraphs().get(j).getCaseList().get(
                                                        k).getCaseList().get(p).getPassages().size(); l++) {
                                            
                                            String c = legald.getParts().get(t).getChapters().get(w).getArticles().get(
                                                    i).getParagraphs().get(j).getCaseList().get(k).getCaseList().get(
                                                    p).getPassages().get(l).getText();
                                ...
                                //If passage has modifications
                                if (legald.getParts().get(t).getChapters().get(w).getArticles().get(
                                        i).getParagraphs().get(j).getCaseList().get(k).getModification() != null) {
                                    ...
                                    if (legald.getParts().get(t).getChapters().get(w).getArticles().get(
                                        ...
                                        Passage p = (Passage) legald.getParts().get(t).getChapters().get(
                                                w).getArticles().get(i).getParagraphs().get(j).getCaseList().get(
                                                k).getModification().getFragment();
                ...
                for (int i = 0; i < legald.getParts().get(t).getArticles().size(); i++) {
                    ...
                    for (int j = 0; j < legald.getParts().get(t).getArticles().get(i).getParagraphs().size(); j++) {
                        ...
                        //get Paragraph id
                        paragraph3.add(
                                "" + legald.getParts().get(t).getArticles().get(i).getParagraphs().get(j).getId() +
                                        ". ");
                        
                        //get Passages
                        for (int k = 0; k < legald.getParts().get(t).getArticles().get(i).getParagraphs().get(
                                j).getPassages().size(); k++) {
                            
                            String a = legald.getParts().get(t).getArticles().get(i).getParagraphs().get(
                                    j).getPassages().get(k).getText();
                            a = trimDoubleQuotes(a);
                            paragraph3.add(a);
                            
                            //If passage has modifications
                            if (legald.getParts().get(t).getArticles().get(i).getParagraphs().get(j).getPassages().get(
                                    k).getModification() != null) {
                                
                                paragraph3.add("\n\n" + quotes[0]);
                                
                                //if Modification type = Paraghraph
                                if (legald.getParts().get(t).getArticles().get(i).getParagraphs().get(
                                        j).getPassages().get(k).getModification().getType().equals("Article")) {
                                    
                                    com.di.nomothesia.model.Article moda =
                                            (com.di.nomothesia.model.Article) legald.getParts().get(
                                                    t).getArticles().get(i).getParagraphs().get(j).getPassages().get(
                                                    k).getModification().getFragment();
                                ...
                                } else if (legald.getParts().get(t).getArticles().get(i).getParagraphs().get(
                                        j).getPassages().get(k).getModification().getType().equals("Paragraph")) {
                                    ...
                                    paragraph3.add("\n");
                                        ...
                                        j).getPassages().get(k).getModification().getType().equals("Passage")) {
                                    
                                    Passage p =
                                            (Passage) legald.getParts().get(t).getArticles().get(i).getParagraphs().get(
                                                    j).getPassages().get(k).getModification().getFragment();
                                    
                                    paragraph3.add(p.getText());
                                }
                                //If Modification type = Case
                                else if (legald.getParts().get(t).getArticles().get(i).getParagraphs().get(
                                        j).getPassages().get(k).getModification().getType().equals("Case")) {
                                    
                                    //get Fragment
                                    Case c = (Case) legald.getParts().get(t).getArticles().get(i).getParagraphs().get(
                                            j).getPassages().get(k).getModification().getFragment();
                        ...
                        for (int k = 0; k < legald.getParts().get(t).getArticles().get(i).getParagraphs().get(
                            ...
                            //get Case Passage
                            for (int l = 0; l < legald.getParts().get(t).getArticles().get(i).getParagraphs().get(
                                    j).getCaseList().get(k).getPassages().size(); l++) {
                                
                                String b = legald.getParts().get(t).getArticles().get(i).getParagraphs().get(
                                        j).getCaseList().get(k).getPassages().get(l).getText();
                                b = trimDoubleQuotes(b);
                                paragraph3.add(b);
                            ...
                            //Case in case
                            if (legald.getParts().get(t).getArticles().get(i).getParagraphs().get(j).getCaseList().get(
                                    k).getCaseList() != null) {
                                
                                for (int p = 0; p < legald.getParts().get(t).getArticles().get(i).getParagraphs().get(
                                        j).getCaseList().get(k).getCaseList().size(); p++) {
                                    ...
                                    //get Case Passage
                                    for (int l = 0; l <
                                            legald.getParts().get(t).getArticles().get(i).getParagraphs().get(
                                                    j).getCaseList().get(k).getCaseList().get(
                                                    p).getPassages().size(); l++) {
                                        
                                        String c = legald.getParts().get(t).getArticles().get(i).getParagraphs().get(
                                                j).getCaseList().get(k).getCaseList().get(p).getPassages().get(
                                                l).getText();
                                        c = trimDoubleQuotes(c);
                                        paragraph3.add(c);
                                        paragraph3.add("\n");
                            ...
                            if (legald.getParts().get(t).getArticles().get(i).getParagraphs().get(j).getCaseList().get(
                                ...
                                if (legald.getParts().get(t).getArticles().get(i).getParagraphs().get(
                                    ...
                                    com.di.nomothesia.model.Article moda =
                                            (com.di.nomothesia.model.Article) legald.getParts().get(
                                                    t).getArticles().get(i).getParagraphs().get(j).getCaseList().get(
                                                    k).getModification().getFragment();
                                    ...
                                    for (int z = 0; z < moda.getParagraphs().size(); z++) {
                                        ...
                                        j).getCaseList().get(k).getModification().getType().equals("Paragraph")) {
                                    ...
                                    paragraph3.add("\n");
                                        ...
                                        j).getCaseList().get(k).getModification().getType().equals("Passage")) {
                                ...
                                //If Modification type = Case
                                        ...
                                        j).getCaseList().get(k).getModification().getType().equals("Case")) {
