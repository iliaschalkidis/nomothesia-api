        ...
        for (int i = 0; i < legald.getArticles().size(); i++) {
            ...
            for (int j = 0; j < legald.getArticles().get(i).getParagraphs().size(); j++) {
                    ...
                    if (legald.getArticles().get(i).getParagraphs().get(j).getPassages().get(k).getModification() !=
                        ...
                        if (legald.getArticles().get(i).getParagraphs().get(j).getPassages().get(
                            ...
                            com.di.nomothesia.model.Article moda =
                                    (com.di.nomothesia.model.Article) legald.getArticles().get(i).getParagraphs().get(
                            ...
                            com.di.nomothesia.model.Paragraph p =
                                    (com.di.nomothesia.model.Paragraph) legald.getArticles().get(i).getParagraphs().get(
                                            j).getPassages().get(k).getModification().getFragment();
                            ...
                            Passage p = (Passage) legald.getArticles().get(i).getParagraphs().get(j).getPassages().get(
                ...
                for (int k = 0; k < legald.getArticles().get(i).getParagraphs().get(j).getCaseList().size(); k++) {
                    ...
                    //get Case Passage
                    for (int l = 0; l < legald.getArticles().get(i).getParagraphs().get(j).getCaseList().get(
                            k).getPassages().size(); l++) {
                        
                        String b = legald.getArticles().get(i).getParagraphs().get(j).getCaseList().get(
                                k).getPassages().get(l).getText();
                    ...
                    if (legald.getArticles().get(i).getParagraphs().get(j).getCaseList().get(k).getCaseList() != null) {
                        ...
                        for (int p = 0; p < legald.getArticles().get(i).getParagraphs().get(j).getCaseList().get(
                            ...
                            for (int l = 0; l < legald.getArticles().get(i).getParagraphs().get(j).getCaseList().get(
                                ...
                                String c = legald.getArticles().get(i).getParagraphs().get(j).getCaseList().get(
                                        k).getCaseList().get(p).getPassages().get(l).getText();
                    ...
                    //If passage has modifications
                    if (legald.getArticles().get(i).getParagraphs().get(j).getCaseList().get(k).getModification() !=
                            null) {
                        ...
                        if (legald.getArticles().get(i).getParagraphs().get(j).getCaseList().get(
                            ...
                            Passage p = (Passage) legald.getArticles().get(i).getParagraphs().get(j).getCaseList().get(
                                    k).getModification().getFragment();
