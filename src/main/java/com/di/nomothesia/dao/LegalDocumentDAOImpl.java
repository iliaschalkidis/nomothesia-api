...
public class LegalDocumentDAOImpl implements LegalDocumentDAO {
    ...
    public LegalDocument getMetadataById(String decisionType, String year, String id) {
        ...
        legald.setURI("http://legislation.di.uoa.gr/eli/" + decisionType + "/" + year + "/" + id);
        String sesameServer = "";
        String repositoryID = "";
            ...
            try {
                ...
                try {
                    ...
                    while (result.hasNext()) {
                        ...
                        if (bindingSet.getValue("type").toString().equals(
                            ...
                            if ((mod == 0) || (mod == 2) || (mod == 3)) {
                                ...
                                "http://legislation.di.uoa.gr/ontology/Image")) {
                            ...
                            if (legald.getParts().isEmpty()) {
                                if (legald.getChapters().isEmpty()) {
                                    ...
                                    legald.getChapters().get(chap_count).getArticles().get(
                                            art_count).getParagraphs().get(count2).getImages().add(trimDoubleQuotes(
                                            bindingSet.getValue("filename").toString().split("\"")[1]));
                                ...
                                if (legald.getParts().get(part_count).getChapters().isEmpty()) {
                                    legald.getParts().get(part_count).getArticles().get(art_count).getParagraphs().get(
                                            count2).getImages().add(trimDoubleQuotes(
                                            bindingSet.getValue("filename").toString().split("\"")[1]));
                                } else {
                            ...
                            legald.getImages().add(
                                    trimDoubleQuotes(bindingSet.getValue("filename").toString().split("\"")[1]));
                        } else if (bindingSet.getValue("type").toString().equals(
                            ...
                            if ((mod == 0) || (!table.contains("modification"))) {
                                ...
                                if (legald.getChapters().isEmpty()) {
                                    legald.getArticles().get(art_count).getParagraphs().get(count2).setTable(
                                            trimDoubleQuotes(table));
                                } else {
                                    legald.getChapters().get(chap_count).getArticles().get(
                                            art_count).getParagraphs().get(count2).setTable(trimDoubleQuotes(table));
                                }
                            ...
                            mod_count4 = -1;
                                ...
                                "http://legislation.di.uoa.gr/ontology/ParsingIssue")) {
                            String text = bindingSet.getValue("text").toString().replace("@el", "");
    ...
    public String getRDFById(String decisionType, String year, String id) {
        ...
        try {
            ...
            try {
                ...
                String queryString =
                        "DESCRIBE <http://legislation.di.uoa.gr/eli/" + decisionType + "/" + year + "/" + id + ">";
                //System.out.println(queryString);
            ...
            try {
                ...
                try {
                    ...
                    while (result.hasNext()) {
                        ...
                        if (!bindingSet.getValue("mod").toString().equals(current)) {
                            ...
                            if (bindingSet.getValue("title") != null) {
                                mod.getCompetenceGround().setTitle(
                                        trimDoubleQuotes(bindingSet.getValue("title").toString().replace("@el", "")));
                            }
                        ...
                        if (bindingSet.getValue("type2").toString().equals(
                                "http://legislation.di.uoa.gr/ontology/Article")) {
                        ...
                        } else if (bindingSet.getValue("type2").toString().equals(
                                "http://legislation.di.uoa.gr/ontology/Paragraph")) {
    ...
    public List<LegalDocument> search(Map<String, String> params) {
        List<LegalDocument> LDs = new ArrayList<>();
        //Apache Lucene searching via criteria
        try {
            Path path = Paths.get(this.getClass().getClassLoader().getResource("/fek_index").toURI());
    ...
    public List<GovernmentGazette> getFEKStatistics() {
        ...
        List<GovernmentGazette> gazs = new ArrayList<>();
        ...
        try {
            ...
            try {
                ...
                String queryString = "PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>\n" +
                        ...
                        "    OPTIONAL{?doc2 eli:published_in ?gaz. ?doc2 rdf:type ?type. ?doc2 eli:has_part+ ?part. " +
                        "?part rdf:type leg:ParsingIssue.}\n" +
                        "}\n" +
                ...
                ArrayList<LegalDocument> lds = new ArrayList<>();
                try {
                    ...
                    try {
                        ...
                        while (result.hasNext()) {
                            ...
                            if (bindingSet.getValue("year") != null) {
                                while (!trimDoubleQuotes(bindingSet.getValue("year").toString().replace(
                                ...
                                typed.add(trimDoubleQuotes(bindingSet.getValue("sum").toString().replace(
                                        "^^<http://www.w3.org/2001/XMLSchema#integer>", "")));
                                k++;
