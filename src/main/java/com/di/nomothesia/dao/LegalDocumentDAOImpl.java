...
import com.di.nomothesia.comparators.GGComparator;
...
public class LegalDocumentDAOImpl implements LegalDocumentDAO {
    ...
    public LegalDocument getMetadataById(String decisionType, String year, String id) {
        ...
        if (decisionType.equals("pd")) {
            ...
            legald.setDecisionType("(–Õ–) –—¡Œ« ÕœÃœ»≈‘… œ’ –≈—…≈◊œÃ≈Õœ’");
        }
        else if(decisionType.equals("rp")){
            legald.setDecisionType("( ƒ)  ¡ÕœÕ…”‘… « ƒ…¡‘¡Œ«");
        }
                        ...
                        while (result.hasNext()) {
                            ...
                            if (bindingSet.getValue("type").toString().equals("http://legislation.di.uoa.gr/ontology/Chapter")) {
                                ...
                                if(mod==1&&chapter.getURI().contains("modification")){
                                    chapter.setId(Integer.parseInt(chapter.getURI().split("chapter\\/")[2].replaceAll("[¡-Ÿ]+","")));
                                }
                                else{
                                   chapter.setId(Integer.parseInt(chapter.getURI().split("chapter\\/")[1].replaceAll("[¡-Ÿ]+","")));
                                }
                                ...
                                if(mod==1&&part.getURI().contains("modification")){
                                    part.setId(Integer.parseInt(part.getURI().split("part\\/")[2].replaceAll("[¡-Ÿ]+","")));
                                }
                                else{
                                    part.setId(Integer.parseInt(part.getURI().split("part\\/")[1].replaceAll("[¡-Ÿ]+","")));
                                }
                                if (bindingSet.getValue("title")!=null) {
                                    String title = bindingSet.getValue("title").toString().replace("@el", "");
                                    title = title.replace("^^", "");
                                ...
                                if(mod==1&&article.getURI().contains("modification")){
                                    article.setId(Integer.parseInt(article.getURI().split("article\\/")[2].replaceAll("[¡-Ÿ]+","")));
                                }
                                else{
                                    article.setId(Integer.parseInt(article.getURI().split("article\\/")[1].replaceAll("[¡-Ÿ]+","")));
                                }
                                if (bindingSet.getValue("title")!=null) {
                                    String title = bindingSet.getValue("title").toString().replace("@el", "");
                                    title = title.replace("^^", "");
                                ...
                                if(mod>=1&&paragraph.getURI().contains("modification")){
                                    paragraph.setId(Integer.parseInt(paragraph.getURI().split("paragraph\\/")[2].replaceAll("[¡-Ÿ]+","")));
                                }
                                else{
                                    paragraph.setId(Integer.parseInt(paragraph.getURI().split("paragraph\\/")[1].replaceAll("[¡-Ÿ]+","")));
                                }
                        ...
                        for (int i=0;i<items.size();i++) {
                            ...
                            if (i == items.size()-1) {
                                ...
                                if (items.get(i).equals("con")) {
                                    ...
                                    queryString += "?type=leg:RegulatoryProvision";
                                }
