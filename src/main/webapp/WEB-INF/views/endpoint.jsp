        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div align="center" style="padding:10px;">
                    <a href="${pageContext.servletContext.contextPath}/legislation/endpoint/query/1" class="btn btn-default" style="width:100%; text-align: left;">Find any modifications applied<br/>to PD/2011/54</a>
                </div>
                <div align="center" style="padding:10px;">
                    <a href="${pageContext.servletContext.contextPath}/legislation/endpoint/query/2" class="btn btn-default" style="width:100%; text-align: left;">Give me the full structure <br/>of PD/2012/10</a>
                </div>
                <div align="center" style="padding:10px;">
                    <a href="${pageContext.servletContext.contextPath}/legislation/endpoint/query/3" class="btn btn-default" style="width:100%; text-align: justify;">Find the government members,<br/>who have signed most decisions <br/>between 2010 and 2014</a>
                </div>
            </div>
            <div class="col-md-9">
            <span style="text-align: center; font-family: 'Comfortaa', cursive;"><h3>ENDPOINT</h3></span>
                <form role="form" action="${pageContext.servletContext.contextPath}/legislation/endpoint">
                  <div class="form-group">
                      <textarea name="query" class="form-control" rows="15" columns="15"><c:choose><c:when test="${empty endpointResults}">
