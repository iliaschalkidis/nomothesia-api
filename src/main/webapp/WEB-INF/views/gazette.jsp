            ...
            <div class="row" style="padding:10px;">
                <div role="tabpanel">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation"><a href="#full" aria-controls="home2" role="tab" data-toggle="tab"
                                                   style="font-family: 'Comfortaa', cursive;"><spring:message code="gazette.full"/></a></li>
                    </ul>
...
<script type="text/javascript" charset="utf-8">
    ...
    $(document).on('shown.bs.tab', '[data-toggle="tab"]', function (e) {
            ...
            $('#example2').css('width', '100%').dataTable().fnAdjustColumnSizing();
        }
    );
</script>
