        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse navbar-menubuilder">
                ...
                <div class="navbar-form navbar-right">
                        <a href="${pageContext.servletContext.contextPath}/search" type="submit" class="btn btn-primary">Σύνθετη Αναζήτηση</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="row" style="margin:10px; padding:10px;">
                <div style="text-align: center; font-family:'Jura'; font-size: 30px;">ΔΗΜΟΦΙΛΕΣΤΕΡΑ</div>
        ...
        <div align="center">
            <a class="btn btn-primary btn-lg" href="downloadPDF"><span class="glyphicon glyphicon-export" aria-hidden="true"></span> Download PDF Document</a>
        </div>
            <br/>
            <br/>
        </div>
