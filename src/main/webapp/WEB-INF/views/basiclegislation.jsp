...
<div class="container">
    <div class="row">
        <!-- Include Buttons -->
        <%@ include file="/resources/html/basic-buttons.html" %>
        <div class="col-md-9">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <div id="share-buttons">
                        <li style="display: inline;">
                            <!-- Facebook -->
                            <a href="https://www.facebook.com/sharer/sharer.php??u=${fn:replace(requestScope['javax.servlet.forward.request_uri'], pageContext.request.contextPath, '')}"
                                        ...
                                        <li${paragraph.getStatus() >= 1?' class="modification2"':"" }>
                                            <div id="article-${article.getId()}-paragraph-${paragraph.getId()}"
                                                ...
                                                <ol class="special-list" style="list-style-type: none;">
                                                    ...
                                                    <c:forEach var="case1" items="${paragraph.getCaseList()}"
                                                        ...
                                                        <li${case1.getStatus() >= 1?' class="modification"':"" }
                                                            ...
                                                            <c:forEach var="passage2" items="${case1.getPassages()}"
                                                                       varStatus="loop">
                                                ...
                                                <c:if test="${not empty paragraph.getImages()}">
                                                    ...
                                                    <c:forEach var="image" items="${legaldoc.getImages()}"
                                                               varStatus="loop">
                                                        <c:set var="imagecount" value="${imagecount+1}"/>
                                                        <a href="/resources/images/leg/${legaldoc.getYear()}/${image}"
                                                           data-lightbox="example-${imagecount}">[${imagecount}]</a>
                                                    </c:forEach>
                                                </c:if>
                                            ...
                                            <c:if test="${paragraph.getStatus() >= 1}">
                                                <c:if test="${paragraph.getStatus() ==2}">
                                                    <span class="clickable" data-toggle="collapse" id="${parcount}"
                                                          data-target=".${parcount}collapsed" style="text-align:right;"><span
                                                            style="cursor: pointer;"
                                                            class="glyphicon glyphicon-transfer"
                                                            aria-hidden="true"></span></span>
                                                    <c:set var="target_uri"
                                                    ...
                                                    <div class="collapse out budgets ${parcount}collapsed"
                                                        ...
                                                        <c:forEach var="frag" items="${fragschanced}" varStatus="loop">
                                                            <c:if test="${fn:endsWith(frag.getURI(),target_uri)}">
                                                                <c:forEach var="passage24" items="${frag.getPassages()}"
                                                                           varStatus="loop">
                                                                    ${passage24.getText()}
                                                                </c:forEach>
                    ...
                    <div role="tabpanel" class="tab-pane" id="list">
                        <ul id="messagescol">
                            <c:forEach var="article" items="${legaldoc.getArticles()}" varStatus="loop">
                                ...
                                %>
                                <li><a href="<c:url value="${legaldoc.getId()}/article/${article.getId()}"/>"
                                       target="_blank"> <spring:message code="basic.article"/> ${article.getId()} <c:if
                                    ...
                                    <ul>
                                        <c:forEach var="paragraph" items="${article.getParagraphs()}" varStatus="loop">
                                            ...
                                            %>
                                            <li><a href="<c:url value="${legaldoc.getId()}/article/${uri1}"/>"
